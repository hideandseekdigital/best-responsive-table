...
var resTable = {
  ...
  createFixedLabels: function createFixedLabels() {
  ...
  updateNavText: function updateNavText() {
  ...
  setCellHeightForOtherRows: function setCellHeightForOtherRows(cellIndex, height) {
    for (var i = 0; i < this.rows.length; i++) {
      var tr = this.rows[i];
  ...
  setCellHeightForLabels: function setCellHeightForLabels(cellIndex, height) {
  ...
  setEqualHeights: function setEqualHeights(rows) {
